...
import com.example.myrest.controller.EmpRestURIConstants;
import com.example.myrest.model.Employee;

import java.util.LinkedHashMap;
import java.util.List;

public class TestSpringRestExample {
	public static final String SERVER_URI = "http://localhost:8080/myrest";
